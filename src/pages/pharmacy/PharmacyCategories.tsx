        ...
        <FilterSection title="Status">
          <PillGroup<StatusFilter>
            ...
            options={[
              ...
              { value: "inactive", label: "Inactive", dot: "bg-muted-foreground/40" },
            ]}
          />
        </FilterSection>
        ...
        {hasActiveFilters && (
          <div className="py-3">
            ...
            <div className="flex flex-wrap gap-1">
              {filters.status !== "all" && (
                <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-sm bg-primary/10 text-primary border border-primary/20 font-medium capitalize">
                  {filters.status}

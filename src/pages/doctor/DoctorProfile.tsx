...
// ─────────────────────────────────────────────────────────────────────────────
// Unified Sidebar — replaces both the left progress panel and inner step nav
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="w-56 shrink-0 flex flex-col border-r border-border bg-card/50">
      ...
      <div className="flex-1 py-3 px-2.5 space-y-0.5 overflow-y-auto">
        {STEPS.map((step, i) => {
          ...
          const isViewActive = !isForm; // all are "browsable" in view mode
...
// ─────────────────────────────────────────────────────────────────────────────
// Multi-step Doctor Profile Form — no inner sidebar (sidebar is unified above)
// ─────────────────────────────────────────────────────────────────────────────
...
const DoctorProfile = () => {
  ...
  // Start in "create" mode if no profile — form shows immediately
  const [mode, setMode] = useState<Mode>("create");

  // Unified sidebar state — hoisted to page level
  ...
  return (
    <DashboardLayout role="doctor">
      ...
      <div className="px-6 py-8 space-y-5">
        {/* ── Stats bar (only when profile exists and viewing) ── */}
        {stats && !isForm && (
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden shadow-sm flex min-h-[560px]">
          ...
          {isForm ? (
            <DoctorProfileForm
              ...
              onCancel={() => {
                // If we have a profile, go back to view. Otherwise stay on create.

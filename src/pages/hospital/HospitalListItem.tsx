  ...
  return (
    <>
      <div className="bg-card border border-border/70 rounded-sm px-3.5 py-2.5 flex items-center gap-3 hover:border-primary/30 hover:shadow-sm transition-all duration-200">
        {/* Avatar */}
        <div className="w-8 h-8 rounded-sm bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 border border-primary/10 text-[11px] font-bold select-none">
          {initial}
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {hospital.type && (
              <span className={cn(
                "px-1 py-px text-[9px] font-semibold rounded-sm border",
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <Button
            ...
            className="h-7 px-2.5 text-[10px] font-medium rounded-sm border-border gap-1.5"
          >
          ...
          <Button
            ...
            className="h-7 px-2.5 text-[10px] font-semibold rounded-sm bg-primary text-primary-foreground hover:bg-primary/90"
          >
            Book
          </Button>
        </div>

  ...
  <div className="container flex items-center justify-between py-3 gap-2">
    ...
    <div className="flex items-center gap-3">
      {[
        ...
        <a key={s.label} href="#" aria-label={s.label} className="text-white/80 hover:text-white transition-colors">
    ...
    {/* RIGHT: email icon | phone icon | support text — icons only on mobile, full text on md+ */}
    <div className="flex items-center gap-3">

      {/* Email — icon always, text on md+ */}
      <a href="mailto:admin@mediconnect.rw" className="flex items-center gap-1.5 text-white/90 hover:text-white transition-colors">
      ...
      {/* Phone — icon always, text on md+ */}
      <a href="tel:+250782168650" className="flex items-center gap-1.5 text-white/90 hover:text-white transition-colors">
        <svg className="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
...
{/* Support — text always visible */}
      ...
      >
        <div className="container flex items-center justify-between py-2 md:py-2">

    ...
    <DashboardLayout role="admin">
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          {/*
           * Filter backdrop — covers phone AND tablet (hidden at lg+).
           */}
          <div
          ...
          <main className="flex-1 overflow-y-auto">
            ...
            {/* Mobile-only search (below stat cards, hidden at sm+) */}
            ...
            <div className="sticky top-0 z-10 mt-3 sm:mt-4 bg-background/90 backdrop-blur-md border-b border-border/60 px-3 sm:px-4 py-2.5 flex items-center justify-between gap-2 sm:gap-3">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                ...
                {/*
                 * Pending badge — visible at md+ (tablet and up).
                 */}
                {pendingCount > 0 && (
              ...
              <div className="flex items-center gap-2 shrink-0">
                {/*
                 * Search input in meta bar — visible at sm+ (phone hides it here,
                 * uses the dedicated search block above instead).
                 */}
                ...
                {/*
                 * Filter button — visible on phone AND tablet (hidden at lg+ where

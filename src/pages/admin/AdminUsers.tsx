...
const roleStyle: Record<string, string> = {
  doctor: "bg-sky-50 text-sky-700 border-sky-200 dark:bg-sky-950/30 dark:text-sky-400 dark:border-sky-900",
  ...
  return (
    <tr className="border-t border-border/40 hover:bg-secondary/20 transition-colors duration-150">
      <td className="px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="font-semibold text-[11px] text-foreground truncate">{u.name}</p>
            <p className="text-[10px] text-muted-foreground/70 truncate">{u.email}</p>
          </div>
        </div>
      </td>
      ...
      <td className="px-4 py-3">
        <Badge
          variant="outline"
          className={cn("border text-[9px] px-1.5 py-0 font-medium capitalize", statusStyle[u.status])}
        >
          <span className={cn("w-1 h-1 rounded-full mr-1", STATUS_DOT[u.status])} />
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl border border-border bg-secondary/30">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      ...
                      <Badge
                        variant="outline"
                        className={cn("border text-xs", statusStyle[selected.status])}
                      >

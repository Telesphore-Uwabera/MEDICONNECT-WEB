...
const bundle = (
  common: any, nav: any, sidebar: any, hero: any, booking: any, rx: any, pages: any, admin: any, auth: any,
) => ({ common, nav, sidebar, hero, booking, rx, pages, admin, auth });
...
i18n
  ...
  .init({
    resources: {
      en: { translation: bundle(enCommon, enNav, enSidebar, enHero, enBooking, enRx, enPages, enAdmin, enAuth) },
      fr: { translation: bundle(frCommon, frNav, frSidebar, frHero, frBooking, frRx, frPages, frAdmin, frAuth) },
      rw: { translation: bundle(rwCommon, rwNav, rwSidebar, rwHero, rwBooking, rwRx, rwPages, rwAdmin, rwAuth) },
    },
    fallbackLng: "en",

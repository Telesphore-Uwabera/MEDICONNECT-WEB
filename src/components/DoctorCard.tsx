...
//     <>
//       {/* ── Card ──
//           rounded-sm + border-border + shadow-sm/hover:shadow-md/-translate-y-px
//           now match HospitalCard exactly. Ring colors for connected/saved-session
//           states kept, just swapped to rounded-sm to stay consistent. */}
//       <div
//         className={cn(
//           "relative rounded-sm border bg-card shadow-sm",
//           "overflow-hidden transition-all duration-200 cursor-pointer",
//           "hover:shadow-md hover:-translate-y-px",
//           isConnected
//             ? "border-emerald-500/30 ring-1 ring-emerald-500/30"
//             : hasSavedSession && !isCallInProgress
//               ? "border-violet-500/30 ring-1 ring-violet-500/25"
...
//                   size="sm"
//                   onClick={openResume}
//                   className="h-8 px-3 text-xs font-semibold rounded-sm bg-violet-600 hover:bg-violet-700 text-white"
//                 >
...
//                   }}
//                   className={cn(
//                     "h-8 px-3 text-xs font-semibold rounded-sm",
//                     isConnected
...
export const DoctorCard = ({
  ...
  return (
    <>
      {/* ── Card ──
          rounded-sm + border-border + shadow-sm/hover:shadow-md/-translate-y-px
          still match HospitalCard. The avatar moved from a small inline
          h-12 square into a full-width h-44/h-52 banner at the top. */}
      <div
        className={cn(
          "relative rounded-sm border bg-card shadow-sm",
          "overflow-hidden transition-all duration-200 cursor-pointer",

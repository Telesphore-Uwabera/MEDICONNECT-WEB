...
//           onSuccess(); // → switches tab to signin in Auth.tsx
//         },
...
const SignUpForm = ({ onSuccess }: { onSuccess: () => void }) => {
  ...
  // When role changes, revoke acceptance (terms are role-specific)
  ...
  return (
    <>
      ...
      {/* Terms drawer — rendered outside the form */}
      <TermsDrawer
        open={drawerOpen}

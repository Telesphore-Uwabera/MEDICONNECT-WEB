...
export function SkeletonCard({ className }: { className?: string }) {
  return (
    <div className={cn("rounded-[6px] border border-border bg-card p-4 animate-pulse space-y-3 shadow-sm", className)}>
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-[6px] bg-muted shrink-0" />
